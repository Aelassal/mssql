...
export class PycusTrialBalanceFilters extends PycusFilters {
    setup(){
        ...
        this.state.show_hierarchy = false;
        ...
        onMounted(() => {
            ...
            this.state.show_hierarchy = this.props.filterValues.show_hierarchy || false
        });
    ...
    onShowHierarchyChanged(ev) {
        this.state.show_hierarchy = ev.target.checked;
        this.props.updateValues(this);
    }
